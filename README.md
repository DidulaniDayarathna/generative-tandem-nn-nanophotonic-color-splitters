...
This repository implements a **Generative Tandem Neural Network (GTNN)** for the inverse design of **color splitter nanophotonic structures**, inspired by the methodology presented in:
...
This enables stable training for inverse design problems that are otherwise non-unique or ill-conditioned.
...
- Loss computed on final predicted optical response vs ground truth
...
3. Train-test split (validation = 30%)
